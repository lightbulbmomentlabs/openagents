...
fn transcript_scroll_clip_bounds(content_bounds: Bounds, composer_height: f32) -> Bounds {
...
fn transcript_content_height(
    ...
    let transcript_scroll_clip = transcript_scroll_clip_bounds(content_bounds, composer_height);
...
pub fn transcript_message_id_at_point(state: &mut RenderState, point: Point) -> Option<u64> {
    ...
    let clip = transcript_scroll_clip_bounds(content_bounds, composer_height);
